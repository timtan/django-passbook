...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pass.barcode'
        db.alter_column('passbook_pass', 'barcode_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['passbook.Barcode']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Pass.barcode'
        raise RuntimeError("Cannot reverse this migration. 'Pass.barcode' and its values cannot be restored.")
