...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Field.text_alignment'
        db.alter_column('passbook_field', 'text_alignment', self.gf('django.db.models.fields.CharField')(max_length=22, null=True))

    def backwards(self, orm):

        # Changing field 'Field.text_alignment'
        db.alter_column('passbook_field', 'text_alignment', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
