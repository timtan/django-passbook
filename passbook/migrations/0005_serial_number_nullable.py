...
def put_pk_to_empty_serail_number( orm ):

    for _pass in orm.Pass.objects.all():
        if _pass.serial_number:
            continue
        _pass.serial_number = _pass.pk
        _pass.save()
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        put_pk_to_empty_serail_number(orm)
